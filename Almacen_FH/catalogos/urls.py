...
urlpatterns = [
    ...
    path('productos/papelera/', views.papelera_productos, name='papelera_productos'),
    path('productos/papelera/<int:pk>/restaurar/', views.restaurar_producto, name='restaurar_producto'),
